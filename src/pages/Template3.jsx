...
const skillCategories = ["Technical", "Programming", "Design", "Marketing", "Management", "Communication", "Other"]
...
export default function ResumeBuilder() {
  ...
  const [skills, setSkills] = useState([
    { id: "1", name: "Data Analysis", category: "Technical", level: 5 },
    { id: "2", name: "Paid Acquisition", category: "Marketing", level: 5 },
    { id: "3", name: "Retargeting", category: "Marketing", level: 4 },
    { id: "4", name: "ROAS Optimization", category: "Marketing", level: 5 },
    { id: "5", name: "Cross-Functional Collaboration", category: "Management", level: 4 },
    { id: "6", name: "Google Analytics", category: "Technical", level: 5 },
    { id: "7", name: "Looker", category: "Technical", level: 4 },
    { id: "8", name: "Appsflyer", category: "Technical", level: 4 },
    { id: "9", name: "Meta Advertising", category: "Marketing", level: 5 },
    { id: "10", name: "Google Ads", category: "Marketing", level: 5 },
    { id: "11", name: "TikTok Ads", category: "Marketing", level: 4 },
    { id: "12", name: "SQL", category: "Programming", level: 3 },
  ])
  ...
  const [languages, setLanguages] = useState([
    ...
    { id: "2", name: "Spanish", level: "Advanced", proficiency: 3 },
  ])
  ...
  const [projects, setProjects] = useState([
    {
      ...
      description: "Built comprehensive marketing automation system that increased lead conversion by 40%",
  ...
  }, [personalInfo, experiences, education, achievements, skills, certifications, languages, projects, theme])
        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${
                    previewMode ? "bg-gray-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                  }`}
                >
          ...
          <main id="main-content">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                  ...
                  <div className="max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
                        ...
                        <div key={exp.id} className="mb-6 p-4 border border-gray-200 rounded-lg">
                          ...
                          <div className="mb-4">
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <label htmlFor={`current-role-${exp.id}`} className="text-sm text-gray-700">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) => {
                                ...
                                updateExperience(exp.id, "responsibilities", responsibilities)
                              }}
                              rows={6}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-vertical"
                    ...
                    <section className="bg-white p-4 sm:p-6 rounded-lg shadow mb-4 sm:mb-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <h2 className="text-lg sm:text-xl font-semibold">Key Achievements</h2>
                        </div>
                        <button
                    ...
                    <section className="bg-white p-4 sm:p-6 rounded-lg shadow mb-4 sm:mb-6">
                      ...
                      {certifications.map((cert, index) => (
                        <div key={cert.id} className="mb-4 p-4 border border-gray-200 rounded-lg">
                          <div className="flex items-center justify-between mb-3">
                    ...
                    <section className="bg-white p-4 sm:p-6 rounded-lg shadow mb-4 sm:mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {languages.map((lang) => (
                          <div key={lang.id} className="p-3 border border-gray-200 rounded-lg">
                            <div className="flex items-center justify-between mb-2">
                            ...
                            <select
                              ...
                              onChange={(e) => {
                                ...
                                updateLanguage(lang.id, "proficiency", proficiencyMap[level] || 1)
                              }}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mb-2"
                            >
                            ...
                            <div className="flex items-center justify-center">{renderDots(lang.proficiency)}</div>
                          </div>
                        ))}
                      </div>
                    </section>
              ...
              <div className={`${previewMode ? "col-span-1" : "order-1 xl:order-2"} xl:sticky xl:top-6 xl:h-fit`}>
                                  ...
                                  <article key={exp.id}>
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 gap-1 sm:gap-0">
                                      <div className="flex-1">
                                        ...
                                        <p className={`${currentTheme.primary} font-medium text-sm break-words`}>
                                          {exp.company}
                                        </p>
                                      </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1 sm:gap-0">
                                      <div className="flex-1">
                                        <h3 className="font-semibold text-gray-900 text-sm sm:text-base break-words">
                                          {edu.degree}
                                          {edu.gpa && (
                                            <span className="ml-2 text-gray-600 font-normal">(GPA: {edu.gpa})</span>
                                          )}
                                        </h3>
                                        <p className={`${currentTheme.primary} font-medium text-sm break-words`}>
                                          {edu.institution}
                              ...
                              {achievements
                                ...
                                .map((achievement) => (
                                  <article key={achievement.id} className="flex gap-3">
                                    ...
                                    >
                                      <div className={currentTheme.primaryText}>{getIcon(achievement.icon)}</div>
                                    </div>
                                    <div className="flex-1 min-w-0">
                                      ...
                                      {achievement.impact && (
                                        <p className={`text-xs ${currentTheme.primaryText} font-medium mt-1`}>
                                ...
                                <div key={category} className="mb-4">
                                  ...
                                  <div className="flex flex-wrap gap-1 sm:gap-2">
                                    {categorySkills.map((skill) => (
                                      ...
                                      >
                                        {skill.name}
                                        <span className="text-xs text-gray-500">{renderDots(skill.level, 5)}</span>
                                      </span>
                                    ))}
                                  </div>
                                </div>
                                ...
                                .map((cert) => (
                                  <article key={cert.id}>
                                    <div className="flex items-start justify-between mb-1">
                                      ...
                                      {cert.date && (
                                        <span className="text-xs text-gray-500 flex-shrink-0 ml-2">{cert.date}</span>
                                      )}
                                    </div>
                                    <p className="text-xs text-gray-600 font-medium mb-1">{cert.issuer}</p>
                                    {cert.description && (
