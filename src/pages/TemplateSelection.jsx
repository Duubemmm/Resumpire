...
const templates = [
  {
    ...
    niche: "Technology",
    description:
      "Perfect for software developers, engineers, and IT professionals",
  ...
  },
  {
    ...
    niche: "Education",
    description:
      "Perfect for teachers, professors, and education administrators",
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {templates.map((template) => (
            <div
              key={template.id}
              className={`bg-white rounded-lg shadow-md cursor-pointer transition-all duration-200 hover:shadow-lg border-2 ${getColorClasses(
                template.color
              )}`}
